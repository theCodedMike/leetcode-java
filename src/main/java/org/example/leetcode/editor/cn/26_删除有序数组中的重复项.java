...
// 
//
// Related Topics 数组 双指针 👍 3346 👎 0


//leetcode submit region begin(Prohibit modification and deletion)
class Solution {
    public int removeDuplicates(int[] nums) {
        //return this.brute_force(nums);
        return this.double_pointer(nums);
    }

    public int brute_force(int[] nums) {
        int len = nums.length;
        int target = nums[0];
    ...
    public int double_pointer(int[] nums) {
        int slow = 0;
